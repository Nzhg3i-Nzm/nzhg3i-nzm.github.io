...
function makeWindow(name, url){
  if (windowmode==true){
    ...
    head.setAttribute("style", "background-color: black; color: white; font-family: 'Kode Mono'; width: 500px; height: 100px; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); border-top-left-radius: 10px; border-top-right-radius: 10px;");
